...
Generative AI was used to create java doc comments as well as test cases and some methods.

# JavaFX Tutorial

Bulk of the GUI was made by following the tutorial [here](https://se-education.org/guides/tutorials/javaFx.html)
