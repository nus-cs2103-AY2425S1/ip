...
This is a project template for a greenfield Java project. It's named after the Java mascot _Bocchi_. Given below are
...
3. After that, locate the `src/main/java/Bocchi.java` file, right-click it, and choose `Run Bocchi.main()` (if the code
