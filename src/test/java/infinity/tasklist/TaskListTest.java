...
public class TaskListTest {
    ...
    public void addTask_overMaxTasksAdded_exceptionCaught() {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "I'm sorry, but I can't remember more tasks.");
    ...
    public void deleteTask_invalidTaskDeleted_exceptionCaught() {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "Hmmm, you seem to have chose a task that doesn't exist. Nice try :)");
    ...
    public void deleteTask_invalidStringParsed_exceptionCaught() {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "Hey! That's not a number");
