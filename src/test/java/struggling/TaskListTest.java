...
public class TaskListTest {
    ...
    private final ArrayList<String> input = new ArrayList<>(Arrays.asList(
            "T | 0 | borrow book",
            "D | 1 | return book | 2024-08-27",
            "E | 0 | project meeting | Mon 2pm | 4pm"));

    @Test
    public void loadTask_corruptedSaveFile_throwException(){
         ArrayList<String> corruptedInput = new ArrayList<>(Arrays.asList(
                "T | 0 | borrow book",
                "Corrupted | 1 | return book | 2024-08-27",
                "E | 0 | project meeting | Mon 2pm | 4pm"));
    ...
    public void getTaskString_returnCorrectFormat(){
        ArrayList<String> stringOutput = new ArrayList<>(Arrays.asList(
                "[T][ ] borrow book",
                "[D][X] return book (by: Aug 27 2024)",
