...
public class TaskTest {
    ...
    public void createEventWithoutDescription() {
        assertThrows(NoTaskDescriptionException.class, () -> Task.createTask("event /from 10-10-2019 "
                + "/to 11-10-2019"));
    }
    ...
    public void createEventWithInvalidDate() {
        assertThrows(InvalidDateException.class, () -> Task.createTask("event wedding /from 10-10-2019 "
                + "/to 11-10-2019"));
    }
    ...
    public void createTaskWithInvalidTaskType() {
        assertThrows(InvalidTaskException.class, () -> Task.createTask("invalidTask wedding "
                + "/from 10-10-2019 /to 11-10-2019"));
    }

    @Test
    public void createTaskNoTagsNoTime() throws NoTaskDescriptionException, InvalidTaskException,
    ...
    public void createTaskNoTags() throws NoTaskDescriptionException, InvalidTaskException, InvalidDateException {
        ...
        assertEquals("[E][ ] wedding (from: Oct 10 2019 18:00 to: Oct 10 2019 23:00) tags: no tags",
                newTask.toString());
    }
    ...
    public void createTaskWithTags() throws NoTaskDescriptionException, InvalidTaskException, InvalidDateException {
        Task newTask = Task.createTask("event wedding /from 10/10/2019 1800 /to 10/10/2019 2300 "
                + "-t important leisure");
        assertEquals("[E][ ] wedding (from: Oct 10 2019 18:00 to: Oct 10 2019 23:00) "
                + "tags: important leisure ", newTask.toString());
    }
}
