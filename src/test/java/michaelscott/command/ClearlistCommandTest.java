...
class ClearlistCommandTest {
    ...
    void testExecute_clearList() {
        ...
        assertEquals("You know what? Forget about it. It’s gone. Just like I forgot about Toby.",
                result, "Message after clearing list is incorrect.");
    }
    ...
    void testExecute_emptyList() {
        ...
        assertEquals("You know what? Forget about it. It’s gone. Just like I forgot about Toby.",
                result, "Message after clearing an empty list is incorrect.");
    }
}
