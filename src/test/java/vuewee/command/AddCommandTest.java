...
public class AddCommandTest {
  ...
  public void testTodoTask() {
    ...
    assertThrows(IllegalCommandException.class, () -> command.execute(taskListUI, taskList, new CommandParser("todo")));
  ...
  public void testEventTask() {
    ...
    // Test invalid date (yyyy-mm-dd)
    assertThrows(IllegalCommandException.class,
        () -> command.execute(taskListUI, taskList, new CommandParser("event a /from 2021-13-01 /to 2020-08-01")));
    assertThrows(IllegalCommandException.class,
        () -> command.execute(taskListUI, taskList, new CommandParser("event a /to 2021-01-32 /from 2020-08-01")));
    ...
    assertEquals(taskList.serialize(), "E | 0 | a | 2020-08-01 | 2020-09-01\nE | 0 | b | 2020-08-01 | 2020-09-01\n");
  }
}