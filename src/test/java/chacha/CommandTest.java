...
public class CommandTest {
    ...
    private CommandParser commandParser = new CommandParser(chacha, chacha.storage, chacha.tasks, chacha.ui);
    ...
    public void doAddEventCommand_correctInput_stringOutput() {
        ...
        String actual = commandParser.parseCommand(input).split("\n")[2]
                .substring(7);
