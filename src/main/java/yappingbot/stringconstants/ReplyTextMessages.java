...
public final class ReplyTextMessages {
    ...
    public static final String UNKNOWN_COMMAND_TEXT_1s =
            "I'm sorry, I do not understand what '%s' is!\n";
    ...
    public static final String SAVE_FILE_NOT_FOUND_EXCEPTION =
            "Savefile not found...\nBeginning with blank list";
    public static final String INVALID_SAVE_FILE_EXCEPTION_1s =
            "Error Reading save file! The following error was encountered: %s";
    public static final String INVALID_SAVE_FILE_EXCEPTION_MISSING_VALUES =
            "Missing Data Values";
    public static final String INVALID_SAVE_FILE_EXCEPTION_INVALID_VALUES_1s =
            "Unable to parse value - %s";
    public static final String SAVEFILE_IO_EXCEPTION_1s =
            "Unable to save list to disk - %s";
    public static final String TIME_PARSE_HINT =
            "Time value must be given in any valid date-time format!";
    public static final String SAVE_FILE_ERROR_1s =
            "Error encountered while saving savefile:\n%s";
    public static final String LOAD_FILE_ERROR_1s =
