...
/**
 * Represents a task that has a deadline. A Deadline task must be completed by a specific date and time.
 * This class extends the Task class and adds a deadline attribute to store the due date.
 */
public class Deadline extends Task {
     ...
     * The format is "D | {status} | {description} | {by}", where {status} is "1" if the task is done, "0" otherwise.
     *
     ...
     * The format is "[D][{status}] {description} (by: {formatted date})".
     *
