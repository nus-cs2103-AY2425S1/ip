 ...
 * An After object corresponds to a task represented by a description and a time/task after which it should be done.
 */
public class After extends Task {
     ...
     * @param after The time/task after which the task should be done.
    ...
    public After(String description, String after) throws CenaInvalidAfterException {
        ...
        try {
            ...
            throw new CenaInvalidAfterException("Incorrect format for after time/task. Please use yyyy-MM-dd HHmm.");
        }
    }
