...
public class Events extends Task{
    ...
    public String getSaveFormat() {
        return String.format("E | %s | %s | %s", super.getSaveFormat(),
                dateToString(this.fromDate,true), dateToString(this.toDate,true));
    }

    @Override
    public String toString() {
        return String.format("[E]%s (from: %s to: %s)", super.toString(),
                dateToString(this.fromDate,false), dateToString(this.toDate,false));
    }
}