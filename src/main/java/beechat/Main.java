...
public class Main extends Application {
    ...
    private void handleUserInput() {
        ...
        if (!input.isEmpty()) {
            String response = beechat.getResponse(input);

            // Add both the user input and chatbot response to the dialog container
            dialogContainer.getChildren().addAll(
                    DialogBox.getUserDialog(input, new ImageView(new Image(this.getClass().getResourceAsStream("/images/user.png")))),
                    DialogBox.getBeechatDialog(response, new ImageView(new Image(this.getClass().getResourceAsStream("/images/beechat.png"))))
            );
    ...
    private void showWelcomeMessage() {
        ...
        String welcomeMessage = beechat.getResponse("welcome");

        dialogContainer.getChildren().add(
                DialogBox.getBeechatDialog(welcomeMessage, new ImageView(new Image(this.getClass().getResourceAsStream("/images/beechat.png"))))
        );
    }
