    ...
    public static Task userInputToTask(String taskTypeStr, String taskArgs) throws IllegalTaskTypeException, IllegalTaskArgumentException {
        ...
        Task task = switch (taskType) {
            ...
            case DEADLINE -> {
                ...
                yield new Deadline(deadlineParts[0].trim(), deadlineParts[1].trim());
            }
            case EVENT -> {
                ...
                yield new Event(eventParts[0].trim(), eventParts[1].trim(), eventParts[2].trim());
            }
        };
        return task;
    }
