...
public class BopesException extends Exception {
    ...
    public static BopesException invalidIndex(int size) {
        return new BopesException(
            "Error: The task index is out of range. Please provide a valid task number between 1 and " + size + ".");
    }
    ...
    public static BopesException invalidNumberFormat() {
        return new BopesException(
            "Error: The provided input is not a valid number. Please enter a valid task number.");
    }
    ...
    public static BopesException invalidDeadlineFormat() {
        return new BopesException(
            "Error: Incorrect deadline format. Please use the format 'deadline <task> /by <dd/MM/yyyy hh:mm a>'.");
    }
