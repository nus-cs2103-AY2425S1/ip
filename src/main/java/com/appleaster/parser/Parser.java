...
public class Parser {
  ...
  private static Command parseMarkUnmark(String commandWord, String arguments) 
      throws AppleasterException {
    if (arguments.isEmpty()) {
      throw new AppleasterException("Please provide a task number to " 
          + commandWord + ". For example: " + commandWord + " 1");
    }
    try {
  ...
  private static Command parseTodo(String description) throws AppleasterException {
    if (description.trim().isEmpty()) {
      throw new AppleasterException("The description of a todo cannot be empty. "
          + "Please provide a description after 'todo'.");
    }
