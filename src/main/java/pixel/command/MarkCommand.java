...
/**
 * Represents a command to mark a task as done in the task list, or mark a task as not done in the
 * task list.
 */
public class MarkCommand extends Command {
     ...
     *
     * @param taskListIndex The index of the task in the task list to be marked as done.
     */
     ...
     *
     * @param input The input string representing the task list index to be marked as done.
    ...
    /**
     * Executes the mark command by marking the specified task as either done or not done in the
     * task list.
     *
