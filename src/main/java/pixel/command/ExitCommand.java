...
/**
 * Represents a command to exit the application. When executed, it displays a farewell message and
...
public class ExitCommand extends Command {
    ...
    /**
     * Executes the exit command. Displays a farewell message and closes the user interface.
     *
