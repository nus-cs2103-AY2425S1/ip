...
/**
 * The DateTimeParser class is responsible for parsing date-time strings into LocalDate objects.
 */
public class DateTimeParser {
     ...
     * @throws PixelException if the input string cannot be parsed into a valid date-time format
     */
    public DateTimeParser(String input) throws PixelException {
        List<DateTimeFormatter> formatters =
                Arrays.asList(DateTimeFormatter.ofPattern("dd-MM-yyyy"),
     ...
     * @throws PixelException if the date-time string cannot be parsed using any of the formatters
     */
    private static LocalDate parseDate(String dateTimeString, List<DateTimeFormatter> formatters)
        ...
        throw new PixelException((String.format(
                "Date-time %s could not be parsed, follow a format like this: dd-MM-yyyy",
                dateTimeString)));
    }

    /**
     * Returns a string representation of the parsed date in the format "dd MMM yyyy".
     *
