 ...
 * This command is responsible for removing a task based on its index,
 * displaying a deletion message to the user interface, and saving the updated
...
public class DeleteCommand extends Command {
     ...
     * displaying a message to the user interface, and saving the updated task list to storage.
     *
     ...
     * @throws LeBronException If the specified index is invalid or an error occurs during command execution.
     */
    @Override
