...
/**
 * This command is responsible for adding a task to the task list, displaying a
...
public class AddCommand extends Command {
    ...
    /**
     * Executes the add command by adding the task to the task list, displaying
     * a message to the user interface, and saving the updated task list to
     * storage.
     *
    ...
    public String execute(TaskList taskList, Ui ui, Storage storage) {
        ...
        String msg = ui.showTaskAdded(task, taskList.size());
