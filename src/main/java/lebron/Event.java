 ...
 * An Event task includes a description, start date, and end date.
 */
public class Event extends Task {
     ...
     * The string includes the task type, status icon, description, and formatted start and end dates.
     *
     ...
     * The string includes the task type, completion status, description, and the raw start and end dates.
     *
