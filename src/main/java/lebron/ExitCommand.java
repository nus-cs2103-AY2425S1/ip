...
/**
 * Represents a command to exit the application. This command is responsible for
 * displaying a goodbye message and closing the input scanner.
 */
public class ExitCommand extends Command {

    /**
     * Executes the exit command by displaying a goodbye message to the user
     * interface and closing the input scanner.
     *
    ...
    public String execute(TaskList taskList, Ui ui, Storage storage) {
        String msg = ui.showGoodbyeMessage();
        System.exit(0);
        return msg;
    }
