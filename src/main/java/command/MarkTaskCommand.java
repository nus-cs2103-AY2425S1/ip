...
public class MarkTaskCommand extends Command {
     ...
     * @throws InvalidCommandKukiShinobuException if the arguments cannot be parsed into an integer.
     */
    public MarkTaskCommand(String arguments) throws InvalidCommandKukiShinobuException {
        try {
