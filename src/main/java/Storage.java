...
public class Storage {
    ...
    public Task parseData(String data) throws DukeException {
    ...
    public ArrayList<Task> loadTasks() throws DukeException {
        try {
          ...
          return tasks;
            ...
            throw new DukeException("Oh no! Error loading tasks from file.");
        }
    }
    ...
    public void saveTasks(ArrayList<Task> tasks) throws DukeException {
        try {
            ...
            throw new DukeException("Oh no! Error saving tasks to file.");
        }
