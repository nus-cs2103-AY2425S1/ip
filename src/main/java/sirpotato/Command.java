...
/**
 * Represents an executable command with hidden logic
 */
public abstract class Command {
     ...
     * @throws SirPotatoException If the Task experiences incorrect input
     * @throws IOException if there is an issue with reading/writing to storage file
     */
    public abstract String execute(TaskList tasks, Ui ui, Storage storage) throws SirPotatoException, IOException;
}
