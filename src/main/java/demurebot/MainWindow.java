...
public class MainWindow extends AnchorPane {
    ...
    private final Image demureBotImage = new Image(this.getClass().getResourceAsStream("/images/DaDemureBot.png"));
    ...
    /**
     * Creates two dialog boxes, one echoing user input and the other containing DemureBot's reply and then appends them to
