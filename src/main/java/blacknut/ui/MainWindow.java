...
public class MainWindow extends AnchorPane {
    ...
    private Blacknut blacknut;

    private Image userImage = new Image(this.getClass().getResourceAsStream("/images/user.png"));
    private Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/blacknut.png"));
    ...
    private void handleUserInput() {
        ...
        String response = blacknut.getResponse(input);
