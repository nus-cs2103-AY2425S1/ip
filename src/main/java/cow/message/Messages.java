...
public class Messages {
    ...
    public static final String TASK_IN_LIST = "Here are the tasks in your list:\n";
    public static final String MATCHING_TASKS_IN_LIST = "Here are the matching tasks in your list:\n";
