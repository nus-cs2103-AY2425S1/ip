...
public class Deadline extends Task {
    ...
    /**
     * Returns a string containing all the information pertaining the task in a specified format for storage purposes.
     *
     * @return String containing all important details of the task.
     */
