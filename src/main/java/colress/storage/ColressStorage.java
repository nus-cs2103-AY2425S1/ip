...
public final class ColressStorage extends Storage {
    ...
    /**
     * Facilitates loading the task from the file to the provided ColressTaskList object.
    ...
    /**
     * Facilitates writing tasks from the provided ColressTaskList object to the text file.
     */
