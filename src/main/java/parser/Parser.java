...
public class Parser {
    ...
    /**
     * Parse a single line of user input and
     * @param userInput
     * @return
     * @throws GrokInvalidUserInputException
     */
    public Command parseUserInput(String userInput) throws GrokInvalidUserInputException {
