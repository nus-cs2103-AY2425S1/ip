...
public class Duck {
     ...
     *
     * @param message The user input to be processed.
    ...
    /**
     * Processes the user input and returns the response generated by the Duck application.
     *
     * @param message The user input to be processed.
     * @throws DuckException If an error occurs while processing the user input.
     */
    public void processInput(String message) throws DuckException {
        Command command = Parser.parse(message);
        command.execute(tasks, storage, ui);
    }
