...
public class Deadline extends Task {
    ...
    private DateTimeFormatter outputFormatter = DateTimeFormatter.ofPattern("dd MMM yyyy");
    ...
    public String getDueDateInInputFormat() {
        return this.dueDate.format(inputFormatter);
    }
