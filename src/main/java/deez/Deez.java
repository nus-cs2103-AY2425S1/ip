  ...
  private void handleAddDeadline(Properties props) throws DeezException {
    try {
      LocalDateTime byDateTime =
          LocalDateTime.parse(props.getProperty("by"), dateTimeInputFormatter);
      Deadline d = new Deadline(props.getProperty("name"), byDateTime);
      taskList.addTask(d);
      Ui.say(
          "Donezo. I have added your task.",
          d.toString(),
          "You have " + taskList.size() + " tasks in the " + "list");
    } catch (DateTimeParseException e) {
      throw new DeezException(
          "Failed to parse deadline date.",
          "Usage:",
  ...
  private void handleAddEvent(Properties props) throws DeezException {
    try {
      LocalDateTime startDate =
          LocalDateTime.parse(props.getProperty("from"), dateTimeInputFormatter);
      ...
      taskList.addTask(e);
      Ui.say(
          "Event added", e.toString(), "You have " + taskList.size() + " tasks in the " + "list");
    } catch (DateTimeParseException e) {
      throw new DeezException(
          "Invalid date.",
          "Usage:",
