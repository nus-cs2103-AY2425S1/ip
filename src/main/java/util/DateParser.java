...
public class DateParser {
     ...
     * <p>
     * This method first splits the input date string by the "/" character, extracts and converts the day, month,
     * and year, then constructs a date string in the "yyyy-MM-dd" format.
     * It also validates the final date format using the standard ISO_LOCAL_DATE formatter.
     *
     ...
     * @throws IllegalArgumentException If the date string cannot be parsed due to invalid format
     *                                  or unrecognized month abbreviation.
     */
