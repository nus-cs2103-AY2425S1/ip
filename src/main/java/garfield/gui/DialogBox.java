...
public class DialogBox extends HBox {
    ...
    /**
     * Creates and returns a DialogBox for the user.
     *
    ...
    /**
     * Creates and returns a DialogBox for Duke, with the dialog box flipped.
     *
     * @param text The text to be displayed in Duke's dialog box.
     * @param img The image to be displayed in Duke's dialog box.
     * @return A DialogBox object representing Duke's flipped dialog.
     */
