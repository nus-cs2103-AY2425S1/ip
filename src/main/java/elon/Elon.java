...
/**
 * The main entry point for the Elon application. Initializes and runs the application, handling
...
public class Elon {
  ...
  /**
   * Starts the application by greeting the user, loading the task list, and processing user input
  ...
  /**
   * The main method to run the Elon application. Initializes the Storage and Elon objects and
