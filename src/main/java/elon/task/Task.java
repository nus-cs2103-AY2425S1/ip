...
public abstract class Task {
  ...
  /**
   * Returns a string representation of the task. The format is "[statusIcon] description", where
   * statusIcon is "X" if the task is done, or a space " " if not done, and description is the
