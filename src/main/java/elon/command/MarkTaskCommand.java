...
public class MarkTaskCommand extends Command {
  ...
  /**
   * Executes the mark task command by marking the task at the specified index as done, saving the
   * updated task list, and returning a message from the Ui. If the index is invalid (out of
   * bounds), it will return an error message.
   *
   * @param list the task list where the task will be marked as done
   * @param ui the user interface to interact with the user
   * @param storage the storage to save the updated task list
   * @return a string representing the result of marking the task or an error message if the index
   *     is invalid
