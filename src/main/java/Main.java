...
public class Main extends Application {
    ...
    private Image chatbotImage = new Image(this.getClass().getResourceAsStream("/images/FrenchPerson.png"));
    private OuiOuiBaguette chatbot = new OuiOuiBaguette("data");
    ...
    private void handleUserInput() {
        ...
        String chatbotText = chatbot.getResponse(userInput.getText());
