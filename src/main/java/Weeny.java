            ...
            try {
                switch (command) {
                    ...
                    case "event":
                        ...
                        Task eventtask = new Events(input.substring(6, input.indexOf("/from") - 1).trim(),
                                input_event(input)[0],
                                input_event(input)[1]);
                        data.add(eventtask);
                        line();
                    ...
                    case "deadline":
                        ...
                        Task deadlinetask = new Deadlines(input.substring(9, input.indexOf("/by") - 1).trim(),
                                input_deadline(input));
                        data.add(deadlinetask);
                        line();
                        System.out.println("Got it. I've added this task:");
