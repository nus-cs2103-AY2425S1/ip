...
/**
 * Parser for command to add an event.
 */
public class EventParser {

    /**
     * Parses the event command for execution.
     *
     * @param userInput User command input.
     * @return Command to add new event to list, else an Error command if an error occurred.
     */
