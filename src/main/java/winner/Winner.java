...
public class Winner {
    ...
    /**
     * Checks if file storing tasks exists, else create file. Loads current tasks, processes user inputs, executes
     * commands based on user inputs and returns a String representing a response based on the user input.
     *
