public class HelpCommand implements Command {
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) {
        ...
        ui.show("2. deadline <description> /by <DD/MM/YYYY HHmm> : Adds a new Deadline task.");
        ui.show("3. event <task description> /from <DD/MM/YYYY HHmm> /to <DD/MM/YYYY HHmm> : Adds a new Event task.");
